...
namespace Authy2FA.Controllers
{
    ...
    {
        private static AuthyClient _authyClient = new AuthyClient(ConfigurationManager.AppSettings["AuthyKey"]);
        ...
        public async Task<ActionResult> VerifyPhoneNumber(VerifyPhoneNumberViewModel model)
        {
            ...
            if (user != null)
            {
                if (_authyClient.VerifyToken(user.AuthyId, model.Code, true).Status == AuthyStatus.Success)
                {
